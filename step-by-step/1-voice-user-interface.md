...
7.  **Fill out the Interaction Model screen.**  Below the screenshot, we have provided links to the content you need to include in each box.
    ...
    ```
    ([get this on GitHub](https://github.com/alexa/skill-sample-node-device-address-api/blob/master/speechAssets/IntentSchema.json))
    ...
    ```
    ([get this on GitHub](https://github.com/alexa/skill-sample-node-device-address-api/blob/master/speechAssets/SampleUtterances.txt))
...
<br/><br/>
[![Next: Lambda Function](https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/general/buttons/button_next_lambda_function._TTH_.png)](https://github.com/alexa/skill-sample-node-device-address-api/blob/master/step-by-step/2-lambda-function.md)
